   ...
   @section('content')
    ...
    <div class="hero-wrap" style="background-image: url('https://cdn.autumna.co.uk/prod/media/images/caregiver_orig_Xo3jjTl.jpg');" data-stellar-background-ratio="0.5">
          ...
          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18 color-3 align-items-stretch">
              <div class="text">
              	...
              	<p>Register in volunteering, a small gesture can work wonders.</p>
